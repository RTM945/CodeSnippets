...
const file_linker_proto_rawDesc = "" +
	"\n" +
	"\flinker.proto\x12\bswitcher\"R\n" +
	"\bEnvelope\x12\x18\n" +
	"\atypeUrl\x18\x01 \x01(\tR\atypeUrl\x12\x12\n" +
	"\x04pvId\x18\x02 \x01(\rR\x04pvId\x12\x18\n" +
	"\apayload\x18\x03 \x01(\fR\apayload\"\x1e\n" +
	"\x04Ping\x12\x16\n" +
	"\x06serial\x18\x01 \x01(\x05R\x06serial\"\x1e\n" +
	"\x04Pong\x12\x16\n" +
	"\x06serial\x18\x02 \x01(\x05R\x06serial2?\n" +
	"\bSwitcher\x123\n" +
	"\x05Route\x12\x12.switcher.Envelope\x1a\x12.switcher.Envelope(\x010\x01B\x14Z\x12/switcher;linkerpbb\x06proto3"
...
var file_linker_proto_goTypes = []any{
	(*Envelope)(nil), // 0: switcher.Envelope
	(*Ping)(nil),     // 1: switcher.Ping
	(*Pong)(nil),     // 2: switcher.Pong
}
var file_linker_proto_depIdxs = []int32{
	0, // 0: switcher.Switcher.Route:input_type -> switcher.Envelope
	0, // 1: switcher.Switcher.Route:output_type -> switcher.Envelope
